...
📌 Sobre o Projeto
O projeto “Educação no Campo” (O projeto explica sbre escolas do Campo e suas adptações)

Por meio de textos, imagens, quiz, curiosidades, vídeo e história em quadrinhos, o site busca aproximar o visitante da realidade das escolas do campo e destacar a importância de produzir com responsabilidade ambiental.
🎯 Objetivo
O objetivo do projeto é compartilhar a realidade as escolas do campo.

O site busca explicar, de maneira simples e interativa, como as adaptações ao clima e a realidade.

🧭 Funcionalidades do Site
O projeto conta com as seguintes funcionalidades:

🏠 Página inicial com intração com o tema;
📱 Menu de navegação responsivo;
🌾 Explicando como a escola do campo funciona;
